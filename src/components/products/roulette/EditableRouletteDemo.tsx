...
interface Props {
  initial:     RouletteData;
  noConfetti?: boolean;
}

// Roleta de demo com editor embutido: o visitante troca título e opções na
// hora — a prova viva de que a roleta do presente é 100% personalizável.
export function EditableRouletteDemo({ initial, noConfetti }: Props) {
  const [data, setData]       = useState<RouletteData>(initial);
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 14, width: '100%' }}>
      <RouletteWheel data={data} noConfetti={noConfetti} />
