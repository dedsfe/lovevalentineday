...
import { ArrowUpRight, Star, Play, SkipBack, SkipForward, Shuffle, Repeat, Heart, Gift } from 'lucide-react';
...
export default function LandingHero() {
  return (
    <section className="relative w-full overflow-hidden bg-white pt-12 pb-20 md:pt-20 md:pb-32">
      ...
      <div className="absolute left-[80%] top-[-10%] -z-10 h-[600px] w-[800px] -translate-x-1/2 rounded-full bg-[#E9D5FF] opacity-40 blur-[120px]" />
      <div className="absolute left-[-10%] bottom-[-10%] -z-10 h-[600px] w-[600px] rounded-full bg-[#E9D5FF] opacity-30 blur-[100px]" />
      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-12 px-4 sm:px-6 lg:flex-row lg:items-center lg:px-8">
        ...
        <div className="flex w-full flex-col items-center text-center lg:w-1/2 lg:items-start lg:text-left">
          ...
          {/* Tag Promocional */}
          <div className="mb-6 inline-flex items-center rounded-full border border-[#E9DDFE] bg-[#Faf5ff] px-4 py-1.5 text-[13px] font-semibold text-[#A855F7] shadow-sm">
          ...
          <h1 className="mb-4 text-[42px] font-bold leading-[1.1] tracking-tight text-[#2D2638] sm:text-6xl lg:text-[64px]">
            ...
            <span className={`${dancingScript.className} text-[#A855F7] font-bold text-[50px] sm:text-[70px] lg:text-[80px] block mt-1`}>
              para sua namorada.
            </span>
          </h1>
          ...
          <Link
            href="#criar"
            className="group flex items-center justify-center gap-2 rounded-2xl bg-[#A855F7] px-8 py-4 text-[17px] font-bold text-white shadow-lg shadow-[#A855F7]/25 transition-all hover:-translate-y-0.5 hover:bg-[#9333EA] w-full sm:w-auto"
          >
          ...
          <div className="mt-12 flex flex-col items-center gap-4 sm:flex-row lg:items-start">
            <div className="flex h-12 w-12 items-center justify-center overflow-hidden rounded-full border-2 border-white shadow-sm bg-gray-200">
              <div className="h-full w-full bg-gradient-to-tr from-gray-400 to-gray-500"></div>
            </div>
            <div className="flex flex-col items-center sm:items-start">
              <div className="flex items-center gap-2">
                ...
                <div className="flex gap-0.5">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <Star key={star} className="h-3 w-3 fill-[#A855F7] text-[#A855F7]" />
                  ))}
                </div>
              </div>
        ...
        <div className="relative w-full lg:w-1/2 flex justify-center lg:justify-end mt-16 lg:mt-0 perspective-1000">
          
          {/* Corações Decorativos Flutuantes (Posições da referência) */}
          <Heart className="absolute top-0 right-[60%] z-20 h-16 w-16 -rotate-12 fill-[#D8B4FE] text-[#D8B4FE] opacity-90" />
          <Heart className="absolute bottom-10 left-0 z-20 h-14 w-14 rotate-12 fill-[#C084FC] text-[#C084FC] opacity-90" />
          <Heart className="absolute top-40 -right-4 z-20 h-20 w-20 rotate-12 fill-[#D8B4FE] text-[#D8B4FE] opacity-80" />
          <Heart className="absolute bottom-20 right-10 z-20 h-12 w-12 -rotate-12 fill-[#E9D5FF] text-[#E9D5FF] opacity-90" />

          {/* Floating Pill: +100.543 Pessoas emocionadas */}
          <div className="absolute -top-6 right-16 z-40 flex items-center gap-3 rounded-2xl bg-white px-4 py-3 shadow-xl border border-gray-100 animate-bounce" style={{ animationDuration: '3s' }}>
          ...
          <div className="relative h-[600px] w-[360px] sm:w-[480px]">
            ...
            <div className="absolute left-0 top-20 z-10 h-[420px] w-[210px] -rotate-[10deg] transform rounded-[2rem] border-8 border-[#1a1a1a] bg-[#121212] p-3 shadow-2xl">
              <div className="flex h-full flex-col">
                <div className="mb-3 h-32 w-full rounded-xl bg-gradient-to-br from-green-400 to-green-600 opacity-90" />
                <div className="mb-2 h-3 w-3/4 rounded bg-white" />
                <div className="mb-4 h-2 w-1/2 rounded bg-gray-400" />
                <div className="mt-auto">
                  <div className="mb-2 h-1 w-full rounded bg-gray-700"><div className="h-full w-1/3 rounded bg-white" /></div>
                  <div className="flex items-center justify-between px-1 text-white">
                    <Shuffle className="h-3 w-3 text-gray-400" />
            ...
            <div className="absolute right-0 top-16 z-10 h-[440px] w-[220px] rotate-[10deg] transform rounded-[2rem] border-8 border-[#1a1a1a] bg-[#2D4263] p-4 shadow-2xl">
              <div className="flex h-full flex-col gap-3">
                ...
                <div className="h-16 w-full rounded-xl bg-[#A855F7]/80 mt-auto" />
              </div>
            </div>

            {/* Celular 2 (Centro/Frente - Casal) */}
            <div className="absolute left-1/2 top-0 z-30 h-[500px] w-[250px] -translate-x-1/2 transform overflow-hidden rounded-[2.5rem] border-[10px] border-[#1a1a1a] bg-white shadow-2xl">
              ...
              <div className="relative flex h-full w-full flex-col bg-[#2D2638]">
                <div className="h-[55%] w-full bg-cover bg-center" style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1518199266791-5375a83164ba?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80")' }}>
                ...
                {/* Contadores da interface do LovePanda */}
                <div className="absolute bottom-6 left-0 flex w-full flex-col gap-3 px-5">
                  ...
                  <div className="rounded-xl bg-[#2563EB] p-3 text-white shadow-lg">
